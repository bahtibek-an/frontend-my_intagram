                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('post.store') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <label for="image" class="col-md-4 col-form-label text-md-right"><strong>Image</strong></label>

                            <div class="col-md-6">
                                <div class="custom-file">
                                    <input type="file" class="custom-file-input @error('image') is-invalid @enderror" name="image" id="image" >
                                    <label class="custom-file-label" for="image">{{ old('image') ?? "Select Image..." }}</label>
