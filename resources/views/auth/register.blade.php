...
<body>
    <div class="login-container">
        ...
        <form class="mt-8 space-y-4" enctype="multipart/form-data" action="{{ route('register') }}" method="POST"
            novalidate>
            @csrf
            <div class="input-group">
                <input name="username" value="{{ old('username') }}"
                type="username" placeholder="Username" inputmode="text" required >
            </div>
            <div class="input-group">
            ...
            <div class="input-group">
                <input  name="picture" id="picture" accept="image/*" type="file">
            </div>
            <div class="input-group">
        ...
        <p style="display: flex; margin-top: 10px; align-items: center; justify-content: center;">
            Do you have account?<a href="{{ route('login') }}" class="forgot-password"> Login</a>
        </p>
