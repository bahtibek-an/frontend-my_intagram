                ...
                <div class="mt-12">
                    <form method="POST" action="{{ route('password.email') }}">
                        ...
                        <div>
                            ...
                            <input
                                class="w-full text-lg py-2 border-b border-gray-300 focus:outline-none rounded focus:border-indigo-500 @error('email') is-invalid @enderror"
                                type="email" name="email" value="{{ old('email') }}" placeholder="E-Mail Address" required autocomplete="email" autofocus>
                        </div>
                        @error('email')
                            <div class="alert alert-danger w-100 mb-1">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="mt-12 text-sm font-display font-semibold text-gray-700 text-center">
                        Remembered you password ? <a href="{{ route('login') }}" class="cursor-pointer text-indigo-600 hover:text-indigo-800">Go ahead and login</a>
                    </div>
                </div>
            </div>
        </div>
