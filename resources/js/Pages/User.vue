            ...
            <div class="flex items-center md:justify-between">
                ...
                <div class="ml-6 w-full">
                    <div class="flex items-center md:mb-8 mb-5">
                        ...
                        <Link v-if="user.id === $page.props.auth.user.id" class="md:block hidden md:mr-6 p-1 px-4 rounded-lg text-[16px] font-extrabold bg-gray-100 hover:bg-gray-200" :href="route('profile.edit')">Edit Profile </Link>
