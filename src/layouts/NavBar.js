          ...
          <div>
            <div className="flex">
              {user ? (
                <>
                <div>
                  <a className="text-[1.8rem]" href="https://github.com/Dilrabo1991"><img className="wp-4 mt-8 mr-2 h-7 w-7" src={github}/></a>
                </div>
                  ...
                  <div className="cursor-pointer flex items-center justify-center mr-6"
                    onClick={() => setOpen(true)}>
                      <FaPlusSquare className="text-[1.8rem] mt-5 mr-2" />
                  ...
                  <div className="mt-7 rounded-full border-2 border-red-500 cursor-pointerflex items-center justify-center w-8 h-8 relative select-none"
