      ...
      <div className="bg-white text-center body">
        ...
        <main class="form-signin card">
          <form onSubmit={handleSubmit}>
            ...
            <p><a href="#" className="text-danger btn m-2" onClick={handleForgotPassword}>Password reset!</a></p>

            <div className="m-2 text-center">
                <p>Don't have an account? <a href="/register" className="w3-text-blue">Sign up</a></p>
            </div>
