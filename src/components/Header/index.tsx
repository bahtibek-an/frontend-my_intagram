                     ...
                     >
                        <div className="flex flex-col gap-y-2 py-2 ">
                           ...
                           <Link
                              ...
                              className="px-4 py-2 flex items-center gap-x-[10px] font-medium text-text-color-black hover:bg-gray-200 transition-all"
                           >
                              <SettingsIcon className="w-3 h-3 text-text-color-black" />
                              <span>Settings</span>
                           </Link>
                        </div>
                        <div 
                           className="bg-red-400 text-text-color-black px-4 py-2  font-medium border-t-2 border-solid border-border-color cursor-pointer hover:bg-red-600 transition-all"
