    ...
    return (
        ...
        {open ? (
            ...
            <div
                ...
                <div ref={postRef} className="border-red-500 rounded-lg shadow-lg relative flex flex-col w-full bg-amber-200  outline-none focus:outline-none">
                    <div className="flex items-center justify-center text-center p-2 border-b border-solid border-red-500 rounded-t">
                        {confirmModal && (
