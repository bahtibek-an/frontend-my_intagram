import React, { useState, useEffect, useRef } from "react"; // rasm tanlagandan keyin chiqadigon pege
...
const ConfirmCreatePost = ({ image, back }) => {
  ...
  return (
    <div className="p-1 items bg-amber-200">
      <div className="flex  justify-center items-center " style={{eight: 350, width: 600 }}>
        <div>
      ...
      <div className="w-520 p-4 flex flex-col justify-between">
        <div className="">
          ...
          <div className="border-b relative">
            ...
            {emoji && (
              <div className="absolute  max-h-sm border rounded"
                style={{ top: "-120px" }} ref={emojiRef}>
                <div className="grid max-h-40 overflow-auto grid-cols-10 p-1">
                  {EMOJISCHAR.map((emoji) => (
                    <div className="hover:bg-white p-1 cursor-pointer"
