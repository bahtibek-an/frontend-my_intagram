  ...
  !username || !fullName ? (
    ...
    <Link
      ...
      className="grid p-4 grid-cols-4 gap-4 mr-5 mb-6 items-center">
       <div className="flex items-center justify-between p-1  rounded-full  border-2 border-red-500 col-span-1 w-20 h-20">
        <img className="avatar " src={avatarSrc} alt="" onError={(e) => {
