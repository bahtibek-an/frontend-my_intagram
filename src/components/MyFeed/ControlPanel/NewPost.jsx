...
import usePostStore from "../../../dataManager/postCollector";
import useUserProfileStore from "../../../dataManager/profileCollector";
import { useLocation } from "react-router-dom";
import { addDoc, arrayUnion, collection, doc, updateDoc } from "firebase/firestore";
import { firestore, storage } from "../../../firebase/firebase_api";
...
const CreatePost = () => {
	...
	const handlePostCreation = async () => {
		try {
			...
			showToast("Error", "Uh-oh! We've encountered an error!", "error");
		}
	};
	...
	return (
		<>
			...
			>
				...
				>
					{/* <CreatePostLogo /> */}
					<Box display={{ base: "none", md: "block" }}>UPLOAD</Box>
				</Flex>
			</Tooltip>
			...
			<Modal isOpen={isOpen} onClose={onClose} size='xl'>
				...
				<ModalContent color="white" bg={"gray.700"} border={"1px solid gray"}>
					...
					<ModalFooter>
						<Button mr={3} bgColor="blue" _hover={""} onClick={handlePostCreation} isLoading={isLoading}>
							Upload
						</Button>
					</ModalFooter>
				</ModalContent>
