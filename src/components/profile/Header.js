...
import Yorliq from './галочка.png';
import {
  ...
  return (
    <div className="grid grid-cols-3 gap-4 justify-between mx-auto max-w-screen-lg">
      <div className="container items-center flex justify-center">
        {avatarSrc ? (
          <div className="rounded-full border-2 border-red-500 p-1 items-center flex justify-center w-[10rem] h-[10rem]">
      ...
      <div className="flex items-center justify-center flex-col col-span-2">
        <div className="container flex items-center">
          <p className="text-2xl mr-4 flex flex-col">{profileUsername}</p><img className="w-8 h-8" src={Yorliq}/>    {/* aaaaaaaaaaaaaaaaa */}
          {activeBtnFollow && (
