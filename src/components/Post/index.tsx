                        ...
                        >
                           <div className=" bg-white rounded-lg py-2 w-40 shadow-box-shadow">
                              {post._user._userId === currentUser?.userId && (
                                 <button
                                    className="flex items-center gap-x-[10px] px-4 py-2 hover:bg-red-500 transition-all w-full"
                                    onClick={(e) => {
                                       e.stopPropagation();
                              ...
                              <button
                                 className="flex items-center gap-x-[10px] px-4 py-2 hover:bg-blue-500 transition-all w-full"
                                 onClick={(e) => {
                                    e.stopPropagation();
                                 }}
                              >
