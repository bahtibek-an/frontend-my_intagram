...
import { arrayRemove, arrayUnion, collection, deleteDoc, deleteField, doc, onSnapshot, query, updateDoc, where } from 'firebase/firestore'
...
const deletePost = async (ref) => {
  try {
    ...
    // await ref.delete();
      ...
      console.log(ref)
      await deleteDoc(doc(db, 'posts', ref.id))
    //  await firebase.firestore().collection("posts").doc(ref.id).delete();

      // если все отлично то тогда так
      // console.log(" deleted");


  } catch (error) {
      //ошибка при выводе удаления 
  ...
  return (
    <>
      {isModalOpen && (
        <ProfileCard deletePost={deletePost} modalInfo={modalInfo} isOpen={isModalOpen} onClose={() => setIsOpenModal(false)}/>
      )}
      <div className="profile-page-section">
        ...
        <div className="profile-page-container">
          ...
          <div className="posts-list-section">
            <div className="posts-list-title">PUBLICATIONS</div>
                ...
                currentUserPosts.map((post) => (
                  ...
                  >
                    ...
                    <div
                      ...
                      className="like-comments-wrapper "
                    >
